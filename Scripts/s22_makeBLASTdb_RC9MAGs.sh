...
#SBATCH --job-name=BLASTdb_RC9
#SBATCH --array=1-18
#SBATCH --cpus-per-task=1
#SBATCH --mem=1G
#SBATCH --output=slurm_out/blastdb_MAGs/x_blastdb_RC9_%a.out
#SBATCH --error=slurm_out/blastdb_MAGs/y_blastdb_RC9_%a.err
...
outdir="${basedir}/d22_BLASTn_MAGs/RC9/db"
