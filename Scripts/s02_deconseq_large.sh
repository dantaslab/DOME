...
#SBATCH --array=1-4
#SBATCH --mem=128G
#SBATCH --output=slurm_out/decon/x_decon_large_%a.out
#SBATCH --error=slurm_out/decon/y_decon_large_%a.err
...
sample=`sed -n ${SLURM_ARRAY_TASK_ID}p ${basedir}/Mapping_v2_large.txt`
