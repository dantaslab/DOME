#!/bin/bash
#===============================================================================
# File Name    : s12_shortbred_BifidobacteriumMAGs_ORFs.sh
# Description  : This script will profile sequence data and isolate genomes. 
# Usage        : sbatch s12_shortbred_BifidobacteriumMAGs_ORFs.sh
# Author       : Bejan Mahmud
# Version      : 1.0
...
#SBATCH --job-name=shortbred_Bifidobacterium
#SBATCH --array=1-271%50
#SBATCH --mem=1G
#SBATCH --output=slurm_out/shortbred_MAGs_ORF/x_shrtbrd_Bifidobacterium_%a.out
#SBATCH --error=slurm_out/shortbred_MAGs_ORF/y_shrtbrd_Bifidobacterium_%a.err
...
# Basedir
basedir="$PWD"
indir="${basedir}/d25_bakta/Bifidobacterium"
outdir="${basedir}/d12_shortbred_MAGs/Bifidobacterium"
