#!/bin/bash
#===============================================================================
# File Name    : s09_dRep_98_nc01.sh
# Description  : Dereplicate a set of highly similar genomes
# Usage        : sbatch s09_dRep_98_nc01.sh
...
#SBATCH --mem=42G
#SBATCH --output=slurm_out/dRep_98_nc01/x_dRep_%a.out
#SBATCH --error=slurm_out/dRep_98_nc01/y_dRep_%a.err
...
outdir="${basedir}/d09_dRep/dRep_98_nc01"
