#!/bin/bash
#===============================================================================
# File Name    : s09_dRep_98_nc02.sh
# Description  : Dereplicate a set of highly similar genomes
# Usage        : sbatch s09_dRep_98_nc02.sh
...
#SBATCH --mem=42G
#SBATCH --output=slurm_out/dRep_98_nc02/x_dRep_%a.out
#SBATCH --error=slurm_out/dRep_98_nc02/y_dRep_%a.err
...
outdir="${basedir}/d09_dRep/dRep_98_nc02"
