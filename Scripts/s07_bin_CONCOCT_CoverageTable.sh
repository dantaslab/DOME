...
#SBATCH --mem=1G
#SBATCH --output=slurm_out/bin_concoct_coverage/x_coverage_%a.out
#SBATCH --error=slurm_out/bin_concoct_coverage/y_coverage_%a.err
...
python CONCOCT_scripts/concoct_coverage_table.py ${outdir}/${sample}/${sample}_contigs_10K.bed ${indir}/${sample}/${sample}_mappedreads_sorted.bam > ${outdir}/${sample}/${sample}_coverage_table.tsv
