...
#===============================================================================
# File Name    : s26_panaroo_RomboutsiaMAGs.sh
# Description  : Runs the panaroo pangenome tool on genomes annotated by bakta
# Usage        : sbatch s26_panaroo_RomboutsiaMAGs.sh
...
#SBATCH --mem=8G
#SBATCH --output=slurm_out/panaroo/x_panaroo_Romboutsia_%A.out
#SBATCH --error=slurm_out/panaroo/y_panaroo_Romboutsia_%A.err

eval $( spack load --sh py-panaroo )

basedir="$PWD"
indir="${basedir}/d25_bakta/Romboutsia"
outdir="${basedir}/d26_panaroo/Romboutsia"
