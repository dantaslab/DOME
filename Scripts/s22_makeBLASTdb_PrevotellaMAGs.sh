#!/bin/bash
#===============================================================================
# File Name    : s22_makeBLASTdb_PrevotellaMAGs.sh
# Description  : This script will make a BLAST database from the input set of seq files
# Usage        : sbatch s22_makeBLASTdb_PrevotellaMAGs.sh
# Author       : Bejan Mahmud
# Version      : 1.0
...
#SBATCH --job-name=BLASTdb_Prevotella
#SBATCH --array=1-101%50
#SBATCH --cpus-per-task=1
#SBATCH --mem=1G
#SBATCH --output=slurm_out/blastdb_MAGs/x_blastdb_Prevotella_%a.out
#SBATCH --error=slurm_out/blastdb_MAGs/y_blastdb_Prevotella_%a.err
...
outdir="${basedir}/d22_BLASTn_MAGs/Prevotella/db"
