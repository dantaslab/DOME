#!/bin/bash
#===============================================================================
# File Name    : s25_bakta_PrevotellaMAGs.sh
# Description  : Annotation of assembled bacterial genomes, MAGs, and plasmids
# Usage        : sbatch s25_bakta_PrevotellaMAGs.sh
...
#SBATCH --job-name=bakta_Prevotella
#SBATCH --array=1-101%10
#SBATCH --cpus-per-task=4
#SBATCH --mem=16G
#SBATCH --output=slurm_out/bakta_Prevotella/x_bakta_%a.out
#SBATCH --error=slurm_out/bakta_Prevotella/y_bakta_%a.err

eval $( spack load --sh py-bakta )

basedir="$PWD"
indir="${basedir}/d07_bin/dastool/HQandMQ_MAGs/allHQandMQ"
outdir="${basedir}/d25_bakta/Prevotella"
