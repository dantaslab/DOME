...
#SBATCH --mem=8G
#SBATCH --output=slurm_out/blastp/x_blastp_DOMEFMG_BLOSUM45.out
#SBATCH --error=slurm_out/blastp/y_blastp_DOMEFMG_BLOSUM45.err
...
time blastp \
  ...
  -matrix BLOSUM45 \
  -out ${outdir}/DOME_FMG-NCBI_CARD-blastp-BLOSUM45.txt
