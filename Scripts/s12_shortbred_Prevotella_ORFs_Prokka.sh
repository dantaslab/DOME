#!/bin/bash
#===============================================================================
# File Name    : s12_shortbred_Prevotella_ORFs.sh
# Description  : This script will profile sequence data and isolate genomes. 
# Usage        : sbatch s12_shortbred_Prevotella_ORFs.sh
# Author       : Bejan Mahmud
# Version      : 1.0
...
#SBATCH --array=2-101%50
#SBATCH --mem=1G
#SBATCH --output=slurm_out/shortbred_Prevotella/x_shrtbrd_%a.out
#SBATCH --error=slurm_out/shortbred_Prevotella/y_shrtbrd_%a.out
...
# Basedir
basedir="$PWD"
indir="${basedir}/d09_dRep/dRep_98_nc01/data/prodigal"
outdir="${basedir}/d12_shortbred_Prevotella"
...
time shortbred_quantify.py --markers /scratch/gdlab/bmahmud/shortBRED/shortBRED-identify/220529/220529_shortbred_FMG-CARD-NCBIAMR_clustId-95pc.faa\
 --genome ${indir}/${sample}.fa.faa\
 --results ${outdir}/${sample}.txt\
 --usearch /opt/apps/usearch/11.0.667/usearch\
 --maxhits 0\
 --maxrejects 0\
 --tmp tmp_shorbred_Prevotella/${sample}_quantify
