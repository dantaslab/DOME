...
#===============================================================================
# File Name    : s17_1_MAGs_dRep_parse_stb.sh
# Description  : This script will use quast to do quality control on assemblies
# Usage        : sbatch s17_1_MAGs_dRep_parse_stb.sh
...
#SBATCH --array=89
#SBATCH --mem=2G
#SBATCH --output=slurm_out/inStrain_stb_MAGs/x_inStrain_stb_%a.out
#SBATCH --error=slurm_out/inStrain_stb_MAGs/y_inStrain_stb_%a.err
