...
#===============================================================================
# File Name    : s27_amrfinder_TreponemaMAGs.sh
# Description  : Annotations ARGs and VFs in assembled genomes or contigs
# Usage        : sbatch s27_amrfinder_TreponemaMAGs.sh
...
#SBATCH --job-name=amrfinder_Treponema
#SBATCH --array=1-152%10
#SBATCH --cpus-per-task=2
#SBATCH --mem=500M
#SBATCH --output=slurm_out/amrfinder_Treponema/x_amrfinder_%a.out
#SBATCH --error=slurm_out/amrfinder_Treponema/y_amrfinder_%a.err

eval $( spack load --sh amrfinder@3.10.42 )

basedir="$PWD"
indir="${basedir}/d25_bakta/Treponema"
outdir="${basedir}/d27_amrfinder/Treponema"
