...
#===============================================================================
# File Name    : s27_amrfinder_TuricibacterMAGs.sh
# Description  : Annotations ARGs and VFs in assembled genomes or contigs
# Usage        : sbatch s27_amrfinder_TuricibacterMAGs.sh
...
#SBATCH --job-name=amrfinder_Turicibacter
#SBATCH --array=1-61%20
#SBATCH --cpus-per-task=2
#SBATCH --mem=500M
#SBATCH --output=slurm_out/amrfinder_Turicibacter/x_amrfinder_%a.out
#SBATCH --error=slurm_out/amrfinder_Turicibacter/y_amrfinder_%a.err

eval $( spack load --sh amrfinder@3.10.42 )

basedir="$PWD"
indir="${basedir}/d25_bakta/Turicibacter"
outdir="${basedir}/d27_amrfinder/Turicibacter"
