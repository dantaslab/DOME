...
#SBATCH --mem=16G
#SBATCH --output=slurm_out/bakta_samples/x_bakta_%a.out
#SBATCH --error=slurm_out/bakta_samples/y_bakta_%a.err

eval $( spack load --sh py-bakta )

basedir="$PWD"
indir="${basedir}/d06_megahit_samples"
outdir="${basedir}/d25_bakta_samples"
