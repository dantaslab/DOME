...
#===============================================================================
#
# File Name    : s21_simka_k17.sh
# Description  : This script will run simka on all clean forward reads with kmer = 17
# Usage        : sbatch s17_simka_k17.sh
# Author       : Bejan Mahmud
# Version      : 1.0
...
#SBATCH --mem=50G
#SBATCH --output=slurm_out/simka_k17/x_simka_%a.out
#SBATCH --error=slurm_out/simka_k17/y_simka_%a.err
