#!/bin/bash
#===============================================================================
# File Name    : s12_shortbred_RomboutsiaMAGs_ORFs.sh
# Description  : This script will profile sequence data and isolate genomes. 
# Usage        : sbatch s12_shortbred_RomboutsiaMAGs_ORFs.sh
# Author       : Bejan Mahmud
# Version      : 1.0
...
#SBATCH --job-name=shortbred_Romboutsia
#SBATCH --array=1-23
#SBATCH --mem=1G
#SBATCH --output=slurm_out/shortbred_MAGs_ORF/x_shrtbrd_Romboutsia_%a.out
#SBATCH --error=slurm_out/shortbred_MAGs_ORF/y_shrtbrd_Romboutsia_%a.err
...
outdir="${basedir}/d12_shortbred_MAGs/Romboutsia"
