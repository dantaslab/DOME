#!/bin/bash
#===============================================================================
# File Name    : s12_shortbred_TuricibacterMAGs_ORFs.sh
# Description  : This script will profile sequence data and isolate genomes. 
# Usage        : sbatch s12_shortbred_TuricibacterMAGs_ORFs.sh
# Author       : Bejan Mahmud
# Version      : 1.0
...
#SBATCH --job-name=shortbred_Turicibacter
#SBATCH --array=1-61%50
#SBATCH --mem=1G
#SBATCH --output=slurm_out/shortbred_MAGs_ORF/x_shrtbrd_Turicibacter_%a.out
#SBATCH --error=slurm_out/shortbred_MAGs_ORF/y_shrtbrd_Turicibacter_%a.err
...
# Basedir
basedir="$PWD"
indir="${basedir}/d25_bakta/Turicibacter"
outdir="${basedir}/d12_shortbred_MAGs/Turicibacter"
