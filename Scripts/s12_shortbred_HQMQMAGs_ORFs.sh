#!/bin/bash
#===============================================================================
# File Name    : s12_shortbred_HQMQMAGs_ORFs.sh
# Description  : This script will profile sequence data and isolate genomes. 
# Usage        : sbatch s12_shortbred_HQMQMAGs_ORFs.sh
# Author       : Bejan Mahmud
# Version      : 1.0
...
#SBATCH --job-name=shortbred_HQMQ
#SBATCH --array=1-4884%100
#SBATCH --mem=1G
#SBATCH --output=slurm_out/shortbred_HQMQMAGs/x_shrtbrd_HQMQ_%a.out
#SBATCH --error=slurm_out/shortbred_HQMQMAGs/y_shrtbrd_HQMQ_%a.err
...
# Basedir
basedir="$PWD"
indir="${basedir}/d25_bakta_HQMQ"
outdir="${basedir}/d12_shortbred_HQMQ"
...
time shortbred_quantify.py --markers /scratch/gdlab/bmahmud/shortBRED/shortBRED-identify/220529/220529_shortbred_FMG-CARD-NCBIAMR_clustId-95pc.faa\
 ...
 --maxhits 0\
 --maxrejects 0\
 --tmp ${outdir}/tmp_shorbred_HQMQ/${sample}_quantify
