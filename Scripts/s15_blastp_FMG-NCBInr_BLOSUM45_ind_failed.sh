#!/bin/bash
#===============================================================================
# File Name    : s15_blastp_FMG-NCBInr_BLOSUM45_ind_failed.sh
# Description  : This script will make a BLAST database from the input set of seq files
# Usage        : sbatch s15_blastp_FMG-NCBInr_BLOSUM45_ind_failed.sh
# Author       : Bejan Mahmud
# Version      : 1.0
...
#SBATCH --mem=1G
#SBATCH --output=slurm_out/blastp_NCBInr_failed/x_blastp_NCBInr_BLOSUM45_%a.out
#SBATCH --error=slurm_out/blastp_NCBInr_failed/y_blastp_NCBInr_BLOSUM45_%a.err
...
query=`sed -n ${SLURM_ARRAY_TASK_ID}p ${basedir}/d19_needle/220818_NCBInr_failedFMGhits.txt`
