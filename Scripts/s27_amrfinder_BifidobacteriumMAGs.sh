...
#===============================================================================
# File Name    : s27_amrfinder_BifidobacteriumMAGs.sh
# Description  : Annotations ARGs and VFs in assembled genomes or contigs
# Usage        : sbatch s27_amrfinder_BifidobacteriumMAGs.sh
...
#SBATCH --job-name=amrfinder_Bifidobacterium
#SBATCH --array=1-271%20
#SBATCH --cpus-per-task=2
#SBATCH --mem=500M
#SBATCH --output=slurm_out/amrfinder_Bifidobacterium/x_amrfinder_%a.out
#SBATCH --error=slurm_out/amrfinder_Bifidobacterium/y_amrfinder_%a.err

eval $( spack load --sh amrfinder@3.10.42 )

basedir="$PWD"
indir="${basedir}/d25_bakta/Bifidobacterium"
outdir="${basedir}/d27_amrfinder/Bifidobacterium"
