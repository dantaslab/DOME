...
#===============================================================================
#
# File Name    : s21_simka_k15.sh
# Description  : This script will run simka on all clean forward reads with kmer = 15
# Usage        : sbatch s17_simka_k15.sh
# Author       : Bejan Mahmud
# Version      : 1.0
...
#SBATCH --mem=50G
#SBATCH --output=slurm_out/simka_k15/x_simka_%a.out
#SBATCH --error=slurm_out/simka_k15/y_simka_%a.err
