#!/bin/bash
#===============================================================================
# File Name    : s09_dRep_98_nc04.sh
# Description  : Dereplicate a set of highly similar genomes
# Usage        : sbatch s09_dRep_98_nc04.sh
...
#SBATCH --mem=42G
#SBATCH --output=slurm_out/dRep_98_nc04/x_dRep_%a.out
#SBATCH --error=slurm_out/dRep_98_nc04/y_dRep_%a.err
...
outdir="${basedir}/d09_dRep/dRep_98_nc04"
