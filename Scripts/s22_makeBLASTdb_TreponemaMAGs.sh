#!/bin/bash
#===============================================================================
# File Name    : s22_makeBLASTdb_TreponemaMAGs.sh
# Description  : This script will make a BLAST database from the input set of seq files
# Usage        : sbatch s22_makeBLASTdb_TreponemaMAGs.sh
# Author       : Bejan Mahmud
# Version      : 1.0
...
#SBATCH --job-name=BLASTdb_Treponema
#SBATCH --array=1-152%50
#SBATCH --cpus-per-task=1
#SBATCH --mem=1G
#SBATCH --output=slurm_out/blastdb_MAGs/x_blastdb_Treponema_%a.out
#SBATCH --error=slurm_out/blastdb_MAGs/y_blastdb_Treponema_%a.err
...
outdir="${basedir}/d22_BLASTn_MAGs/Treponema/db"
