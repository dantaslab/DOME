#!/bin/bash
#===============================================================================
# File Name    : s22_makeBLASTdb_TuricibacterMAGs.sh
# Description  : This script will make a BLAST database from the input set of seq files
# Usage        : sbatch s22_makeBLASTdb_TuricibacterMAGs.sh
# Author       : Bejan Mahmud
# Version      : 1.0
...
#SBATCH --job-name=BLASTdb_Turicibacter
#SBATCH --array=1-61%10
#SBATCH --cpus-per-task=1
#SBATCH --mem=1G
#SBATCH --output=slurm_out/blastdb_MAGs/x_blastdb_Turicibacter_%a.out
#SBATCH --error=slurm_out/blastdb_MAGs/y_blastdb_Turicibacter_%a.err
...
outdir="${basedir}/d22_BLASTn_MAGs/Turicibacter/db"
